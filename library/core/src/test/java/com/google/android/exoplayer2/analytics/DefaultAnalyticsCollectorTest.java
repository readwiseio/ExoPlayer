...
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_DECODER_INITIALIZED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_DISABLED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_ENABLED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_INPUT_FORMAT_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_POSITION_ADVANCING;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_DOWNSTREAM_FORMAT_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_DRM_KEYS_LOADED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_DRM_SESSION_ACQUIRED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_DRM_SESSION_MANAGER_ERROR;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_DRM_SESSION_RELEASED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_DROPPED_VIDEO_FRAMES;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_IS_LOADING_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_IS_PLAYING_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_LOAD_COMPLETED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_LOAD_ERROR;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_LOAD_STARTED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_MEDIA_ITEM_TRANSITION;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_PLAYBACK_PARAMETERS_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_PLAYBACK_STATE_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_PLAYER_ERROR;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_PLAYER_RELEASED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_PLAY_WHEN_READY_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_POSITION_DISCONTINUITY;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_RENDERED_FIRST_FRAME;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_TIMELINE_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_TRACKS_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_DECODER_INITIALIZED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_DISABLED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_ENABLED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_FRAME_PROCESSING_OFFSET;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_INPUT_FORMAT_CHANGED;
import static com.readwise.android.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_SIZE_CHANGED;
import static com.readwise.android.exoplayer2.robolectric.TestPlayerRunHelper.playUntilPosition;
import static com.readwise.android.exoplayer2.robolectric.TestPlayerRunHelper.runUntilError;
import static com.readwise.android.exoplayer2.robolectric.TestPlayerRunHelper.runUntilIsLoading;
import static com.readwise.android.exoplayer2.robolectric.TestPlayerRunHelper.runUntilPendingCommandsAreFullyHandled;
import static com.readwise.android.exoplayer2.robolectric.TestPlayerRunHelper.runUntilPlaybackState;
import static com.readwise.android.exoplayer2.robolectric.TestPlayerRunHelper.runUntilTimelineChanged;
...
import com.readwise.android.exoplayer2.drm.ExoMediaDrm;
import com.readwise.android.exoplayer2.drm.MediaDrmCallback;
import com.readwise.android.exoplayer2.drm.MediaDrmCallbackException;
...
import com.readwise.android.exoplayer2.source.ConcatenatingMediaSource;
...
import com.readwise.android.exoplayer2.testutil.ExoPlayerTestRunner;
import com.readwise.android.exoplayer2.testutil.FakeAudioRenderer;
import com.readwise.android.exoplayer2.testutil.FakeClock;
import com.readwise.android.exoplayer2.testutil.FakeExoMediaDrm;
import com.readwise.android.exoplayer2.testutil.FakeMediaSource;
import com.readwise.android.exoplayer2.testutil.FakeRenderer;
...
import com.readwise.android.exoplayer2.testutil.FakeVideoRenderer;
