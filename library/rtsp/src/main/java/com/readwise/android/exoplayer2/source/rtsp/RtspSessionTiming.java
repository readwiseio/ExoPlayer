...
/* package */ final class RtspSessionTiming {
  ...
  public static RtspSessionTiming parseTiming(String sdpRangeAttribute) throws ParserException {
    ...
    RtspMessageUtil.checkManifestExpression(matcher.matches(), /* message= */ sdpRangeAttribute);

    @Nullable String startTimeString = matcher.group(1);
    RtspMessageUtil.checkManifestExpression(startTimeString != null, /* message= */ sdpRangeAttribute);
    ...
    if (stopTimeString != null) {
      ...
      RtspMessageUtil.checkManifestExpression(stopTimeMs >= startTimeMs, /* message= */ sdpRangeAttribute);
    } else {
