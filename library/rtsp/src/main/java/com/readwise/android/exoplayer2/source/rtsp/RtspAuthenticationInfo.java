...
/* package */ final class RtspAuthenticationInfo {
   ...
   *
   * @param authUserInfo The {@link RtspMessageUtil.RtspAuthUserInfo} for authentication.
  ...
  public String getAuthorizationHeaderValue(
      RtspMessageUtil.RtspAuthUserInfo authUserInfo, Uri uri, @RtspRequest.Method int requestMethod)
